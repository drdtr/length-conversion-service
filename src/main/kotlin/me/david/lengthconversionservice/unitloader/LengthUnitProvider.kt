...
class LengthUnitProvider(
    ...
    private val lengthUnitsBySymbol: Map<String, LengthUnit> = lengthUnits.associateBy { it.symbol }

    fun getLengthUnitBySymbol(symbol: String): LengthUnit? = lengthUnitsBySymbol[symbol]
